...
const routes = [
    ...
    {
        path: 'user-profile',
        loadChildren: () => __webpack_require__.e(/*! import() | user-profile-user-profile-module */ "user-profile-user-profile-module").then(__webpack_require__.bind(null, /*! ./user-profile/user-profile.module */ "./src/app/user-profile/user-profile.module.ts")).then(m => m.UserProfilePageModule)
    },
    {
        path: 'category',
    ...
    {
        path: 'product-detail',
        loadChildren: () => __webpack_require__.e(/*! import() | product-detail-product-detail-module */ "product-detail-product-detail-module").then(__webpack_require__.bind(null, /*! ./product-detail/product-detail.module */ "./src/app/product-detail/product-detail.module.ts")).then(m => m.ProductDetailPageModule)
    }
];
...
module.exports = __webpack_require__(/*! /Users/tasmin/softbyte/ECommerceApp/ECommerce/src/main.ts */"./src/main.ts");
